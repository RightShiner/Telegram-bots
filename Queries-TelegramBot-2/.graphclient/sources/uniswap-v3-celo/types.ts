...
export namespace UniswapV3CeloTypes {
...
export type LiquidityPoolHourlySnapshot_orderBy =
  ...
  | 'cumulativeVolumeUSD'
  | 'hourlyTotalVolumeUSD'
  | 'cumulativeVolumeTokenAmounts'
  | 'hourlyVolumeTokenAmounts'
  | 'cumulativeVolumesUSD'
  | 'hourlyVolumesUSD'
  | 'inputTokenBalances'
  | 'inputTokenBalancesUSD'
...
export type _TokenWhitelist_orderBy =
  ...
  export type Context = {
      ["uniswap-v3-celo"]: { Query: QuerySdk, Mutation: MutationSdk, Subscription: SubscriptionSdk },
